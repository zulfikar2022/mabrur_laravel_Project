        ...
        <>
            <MainLayout user={user} title={"প্রোডাক্ট আপডেট করুন"}>
                <div className="max-w-md sm:mx-5 md:mx-auto mt-10 p-6 shadow-lg rounded-lg bg-white text-black mb-10">
                    ...
                    <h2 className="text-2xl font-bold mb-6 text-center text-blue-600">প্রোডাক্ট আপডেট করুন</h2>

                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* ক্যাটাগরি ড্রপডাউন */}
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text text-blue-600">প্রোডাক্টের ধরন</span>
                            </label>
                            <select
                        ...
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text text-blue-600">নাম</span>
                            </label>
                            <input
                                type="text"
                                name='name'
                        ...
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text text-blue-600">হালকা বিস্তারিত</span>
                            </label>
                            <textarea
                        ...
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text text-blue-600">প্রতি কেজির মূল্য</span>
                            </label>
                            <input
                                type="number"
                                step="1"
                        ...
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text text-blue-600">মোট পরিমাণ (কেজি)</span>
                            </label>
                            <input
                                type="number"
                                step="1"
                        ...
                        <button disabled={processing} type="submit" className="btn bg-blue-600 border-none w-full">
                            সংরক্ষণ করুন
                        </button>
                    </form>
                </div>
